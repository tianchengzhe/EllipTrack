function [curve,curve_start,curve_end,curve_mode,cur_num]=mia_extract_curve(BW,Gap_size, min_ellipse_perimeter)
...
%   Add a threshold for minimal accepted ellipse perimeter
...
while size(r,1)>0
    ...
    if size(cur,1)>=min_ellipse_perimeter
        cur_num=cur_num+1;
