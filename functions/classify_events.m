function [ all_morphology_posterior_prob ] = classify_events( morphology_training_info, all_ellipse_info, track_para )
...
all_cell_count_prob = classify_num_cells_per_ellipse(morphology_training_features, morphology_training_labels, all_ellipse_info, track_para);

% classify others
all_before_mitosis_prob = classify_single_event(morphology_training_features, morphology_training_labels, 4, all_ellipse_info, track_para);
all_after_mitosis_prob = classify_single_event(morphology_training_features, morphology_training_labels, 5, all_ellipse_info, track_para);
all_apoptosis_prob = classify_single_event(morphology_training_features, morphology_training_labels, 6, all_ellipse_info, track_para);
